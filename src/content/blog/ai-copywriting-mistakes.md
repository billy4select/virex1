...
description: >-
  AI 寫出來的文案，你改來改去卻說不清楚哪裡不對。其實問題有規律可循。這篇整理 AI 文案最常出現的三種錯，以及 ChatGPT 和 Claude
  各自容易犯哪一種。
publishedDate: 2026-04-19T08:45:12Z
...
faq:
  - q: AI 寫的文案為什麼讀起來感覺「不像人寫的」？
    a: >-
      通常是因為 AI
      傾向用「完整句子」填滿每一格，缺乏節奏變化，也不會在對的地方留白。人在寫文案時會刻意打破語法、製造停頓、甚至用不完整的句子製造力道。AI
      預設不這樣做，除非你明確要求。
  - q: 怎麼讓 AI 少犯這些錯？
    a: >-
      最有效的方式是在 prompt
      裡給它限制，而不是給它自由。例如：「不可以用條列式」「結尾不要有呼籲行動」「語氣要像朋友講話，不是業務員」。給的限制越具體，它犯錯的空間越小。
  - q: ChatGPT 和 Claude 哪個比較適合寫文案？
    a: >-
      取決於你要寫什麼。ChatGPT 適合短篇、需要節奏感的廣告文案；Claude
      適合需要論述和說服力的長篇內容。兩個都會犯不同的錯，了解它們各自的毛病，比選邊站更有用。
---
