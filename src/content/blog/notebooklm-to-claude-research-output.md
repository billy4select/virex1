...
faq:
  - q: 為什麼不直接用 Claude 做研究和輸出？
    a: >-
      Claude 沒有辦法「記住」你的文件。你把資料貼給它，那次對話結束就消失了。如果你的研究素材很多、需要反覆查詢，NotebookLM 能長期保存這些資料並隨時回應。用 NotebookLM 建知識庫、Claude 負責生成，是讓兩個工具各做各擅長的事。
  - q: 從 NotebookLM 複製內容給 Claude，會不會有資安問題？
    a: >-
      取決於原始資料的性質。如果你在 NotebookLM 裡存放的是公司機密文件，整理出來的摘要雖然已經脫離原始格式，但核心內容還在，貼給外部 AI 之前仍需確認公司政策。如果是公開資料整理而成的摘要，一般沒有問題。
  - q: 這個流程適合什麼類型的輸出？
    a: >-
      適合需要「先有研究基礎、再生成內容」的工作。例如：競品分析報告、提案文件、客戶簡報、深度文章。不適合純粹的快速問答或不需要資料基礎的創意發想。
steps:
  ...
  - name: 把整理結果交給 Claude
    text: 把 NotebookLM 整理出來的內容貼給 Claude，告訴它你要輸出的格式和對象。這個時候 Claude 的任務是「把你已經有的東西寫成你要的形式」，不是從頭研究。
...
「這幾份資料裡，哪些觀點是多份文件都有提到的？」
「這個主題有沒有出現過互相矛盾的說法？分別是什麼？」
「如果要寫一份給主管看的摘要，最重要的三個結論是什麼？」
