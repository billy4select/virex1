...
這不是誰比較聰明，是思考方式不同。如果你的 prompt 習慣「說重點、省細節」，Claude 比較對你的胃口。如果你習慣「條列清楚、逐項給指令」，ChatGPT 會更好控制。
...
ChatGPT 不是不能做，但如果提案超過四到五個段落，你可能需要分段給它，再自己把各段接起來。
...
**用任何工具，但沒給足夠的背景資料**：不管 Claude 還是 ChatGPT，如果你只給它「幫我寫提案」四個字，它只能給你一個通用框架。你的客戶是誰、痛點是什麼、預算範圍、決策者是誰——這些東西你給得越具體，它輸出的東西越接近你要的，修改次數才會降下來。
...
**延伸閱讀：** [同一個 prompt 丟給不同 AI，結果差這麼多——行銷人的工具校準筆記](/blog/prompt-ai-tool-calibration)