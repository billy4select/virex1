...
**範例**：
「這幾份競品報告裡，關於定價策略，有哪些值得注意的資訊？」
「這批客戶訪談記錄裡，客戶提到了哪些類型的問題？」
...
**範例**：
「這幾份報告對這個市場的判斷有沒有互相矛盾的地方？」
「上面這個結論，文件裡有沒有任何反例或例外情況？」
...
**範例**：
「如果你是一個預算壓力很大的行銷主管，看完這份提案你會有什麼問題？」
「如果你是一個對這個產品半信半疑的客戶，這批資料能解答你的疑慮嗎？哪些地方還不夠有說服力？」
...
**範例**：
「如果我要寫一篇給非專業讀者看的市場分析，這批資料裡最容易說清楚的三個重點是什麼？」
「如果我要在十分鐘的簡報裡介紹這個競品研究，最關鍵的發現是哪三個？」
